...
```{python}
#| label: fig-upwind-exp-3D
#| fig-cap: "3D Visualization of 1D Advection Equation: $u_t + c u_x = 0$."
import numpy as np
import matplotlib.pyplot as plt
...
```{python}
#| label: fig-upwind-square-3D
#| fig-cap: "1D First-Order Wave Equation: Evolution of u(x,t) over time."
...
```{python}
#| label: fig-wave-equation-string-3D
#| fig-cap: "Wave Propagation Surface."
import numpy as np
import matplotlib.pyplot as plt
from mpl_toolkits.mplot3d import Axes3D
...
```{python}
#| label: fig-robot-link-vibration-3D
#| fig-cap: "3D surface plot showing how displacement $u(x,t)$ evolves in both space and time."
import numpy as np
import matplotlib.pyplot as plt
from mpl_toolkits.mplot3d import Axes3D
...
```{python}
#| label: fig-heat-equation-explicit-3D
#| fig-cap: "Diffusion of a central heat pulse over time, calculated with the FTCS explicit method in 3D."
...
```{python}
#| label: fig-heat-challenge-3D
#| fig-cap: "Heat Dissipation in a 3.2m Rod."
